  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h3 className="text-lg font-semibold">Approval Policies</h3>
                ...
                policies.map((policy) => (
                  <tr key={policy.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      <code className="px-2 py-1 bg-gray-100 rounded text-xs">{policy.tool}</code>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900 max-w-xs truncate">
                      {policy.condition ? (
                        <code className="text-xs">{policy.condition}</code>
                      ) : (
                        <span className="text-gray-400 italic">Always applies</span>
                      )}
                    </td>
